...
{
    public class GradientThreeColors : BaseMeshEffect
    {
        [SerializeField]
        ...
        [SerializeField]
        private Color _vertex3 = Color.black;
        ...
        public Color Vertex3 { get { return _vertex2; } set { _vertex2 = value; graphic.SetAllDirty(); } }
        #endregion
